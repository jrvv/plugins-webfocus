...
(function ( $ ) {
    $.fn.jwfselect2 = function( options ) {
		...
		var languageJson={en_US:{fex_ajax:'The variable fex_ajax is necessary',
                    ...
                    es_ES:{fex_ajax:'La variable fex_ajax es necesaria',
                    ...
                    ca_CA:{fex_ajax:'La variable fex_ajax ÃƒÂ©s necessÃƒÂ ria',
