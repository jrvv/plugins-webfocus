	...
	var facilities = {
			    ...
			    switch (arguments[i]){
			        case 'jwfselect2':
			            arrayComponents[0] = checkArrayPosition(arrayComponents[0]).concat([
                            'IBFS:/WFC/Repository/Public/system/plugins/jwfselect2/select2/select2.css',
                            'IBFS:/WFC/Repository/Public/system/plugins/jwfselect2/select2/select2.js'
                        ]);
                        arrayComponents[1] = checkArrayPosition(arrayComponents[1]).concat([
                            'IBFS:/WFC/Repository/Public/system/plugins/jwfselect2/jwfselect2.js'
                        ]);
			            break;
			        case 'ibxRadioGroup_selectedToFirst':
			             arrayComponents[0] = checkArrayPosition(arrayComponents[0]).concat([
			                  'IBFS:/WFC/Repository/Public/system/plugins/ibxRadioGroup_selectedToFirst/ibxradiogroup_selectedtofirst.js',
			             ]);
			            break;
			      case 'hideSection_onSubmit':
			             arrayComponents[0] = checkArrayPosition(arrayComponents[0]).concat([
			                  'IBFS:/WFC/Repository/Public/system/plugins/hideSectionsOnsubmit/hidesectiononsubmit.js',
			             ]);
			            break;
		...
		createJwfSelect2: function(options){
		    var _defaults = {
                    ...
                    repository: 'Public/system/plugins/jwfselect2/',
                    order_by: null,
                    language: 'en_US',
                    num_lines: 15,
                    multiple: true,
...
//                    filtersContainer: $(settings.page._element).find('[data-ibx-type="pdFilterGrid"]')[0],
            ...
            $div_jwfselect2.jwfselect2({
                ...
                lang_folder: '/ibi_apps/run.bip?BIP_REQUEST_TYPE=BIP_LAUNCH&BIP_folder=IBFS:/WFC/Repository/Public/system/plugins/jwfselect2/select2/i18n/&BIP_item=',
